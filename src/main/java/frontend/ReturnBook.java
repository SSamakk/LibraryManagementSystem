...
public class ReturnBook extends javax.swing.JFrame implements Node{
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int NumberOfOperations=librarian.getListOfBorrowingOperations().length;
        
        try
        {
            checkStatus = librarian.returnBook(StudentID, BookID, convertToLocalDate(BorrowDate));
            if (NumberOfOperations == librarian.getListOfBorrowingOperations().length){
                JOptionPane.showMessageDialog(null, " Currently no borrowing operation is occuring by this student for this book");             
                return;
            } 
            JOptionPane.showMessageDialog(null, " The student with id = " + StudentID + " should pay a return fee of " + checkStatus + " US dollars for the book with id " + BookID);
            jTextField1.setText("");
            jTextField2.setText("");
